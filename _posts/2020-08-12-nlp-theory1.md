...
자연어처리를 하기 위해서는 기본적으로 필요한 프로그램들이 있습니다. 앞으로의 순탄한 학습과 실습을 생각한다면, 이 프로그램들을 잘 설치하는 것이 매우 중요한 시작이라 할 수 있습니다. 하나씩 아래 설명을 따라서 설치를 진행하도록 하겠습니다.
...
<a  href=" https://imgur.com/ySuOekO"><img  src="https://i.imgur.com/ySuOekO.png"  width="500px"  title="source: imgur.com"  /></a>

cmd(커맨드창)을 띄워 python을 입력하고 위와 같이 python에 대한 정보가 출력되면 정상적으로 파이썬 설치가 완료된 것입니다.
